# PRD: Smart Home Configurator — Frontend Usability Improvements
...
*Acceptance:* On every question step, a user can advance or go back without scrolling below the image row.
...
*Acceptance:* A checklist of all options exists, with zero items marked "missing image" or "missing text".
...
*Acceptance:* Visual QA confirms configurator and catalogue card states are pixel-consistent.
...
*Acceptance:* On any question, a user can identify (a) which section they are in, (b) which sub-step is active, (c) how many sub-steps remain, and (d) overall completion percentage.
...
*Acceptance:* Navigation click → landing page with copy visible; CTA click → question 1.
